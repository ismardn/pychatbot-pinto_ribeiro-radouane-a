...
Pour lancer le programme, exécuter le fichier Python "main.py" (dans PyCharm, de préférence*), puis suivez les instructions.

*L'affichage de la matrice TF-IDF (Fonctionnalité n°9) se fait correctement dans les consoles/terminaux sur lesquelles on peut se déplacer horizontalement (et qui ne dépendent donc pas de la largeur de la fenêtre). L'affichage fonctionne très bien avec la console de PyCharm.
